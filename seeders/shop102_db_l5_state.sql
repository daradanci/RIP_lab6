...
LOCK TABLES `l5_state` WRITE;
/*!40000 ALTER TABLE `l5_state` DISABLE KEYS */;
INSERT INTO `l5_state` VALUES (2,'Оплачено'),(1,'Оформление');
/*!40000 ALTER TABLE `l5_state` ENABLE KEYS */;
UNLOCK TABLES;
